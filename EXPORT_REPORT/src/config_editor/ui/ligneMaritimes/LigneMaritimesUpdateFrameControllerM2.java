 ...
 * @version 1.0
 */
public class LigneMaritimesUpdateFrameControllerM2 extends FormController {
    
    private LigneMaritimesGridFramesM2 frame = null;
    private String pk = null;
    Cryptages ocryptage = new Cryptages();
    
    public LigneMaritimesUpdateFrameControllerM2(String pk) {
        this.pk = pk;
        frame = new LigneMaritimesGridFramesM2(this);
        MDIFrame.add(frame);
    ...
    public Response loadData(Class valueObjectClass) {
        ...
        try {
            ...
            return new VOResponse(new GridLigneMaritimesVOM2());
   ...
   public Response updateRecord(ValueObject oldPersistentObject, ValueObject persistentObject) throws Exception {
        ...
        try {
            ...
            Cryptages ocryptage = new Cryptages();
            GridLigneMaritimesVOM2 vo = (GridLigneMaritimesVOM2) persistentObject;
            ...
            vo.setPoids_vgm(vo.getPoids_vgm());
            vo.setHeur_empotage(vo.getHeur().toString() + ":" + vo.getMin().toString());
            ...
            Odata = Odata.replace("[" + vo.KEY_heur_empotage + "]", vo.getHeur_empotage());
            ...
            Odata = Odata.replace("[" + vo.KEY_poids_pesee_1 + "]", vo.getPoids_vgm() + "");
            Odata = Odata.replace("[" + vo.KEY_poids_pesee_2 + "]", vo.getPoids_vgm() + "");
            Odata = Odata.replace("[" + vo.KEY_poids_vgm + "]", vo.getPoids_vgm() + "");
            Odata = Odata.replace("[" + vo.KEY_date_empotage + "]", new date().DateToString(vo.getDate_empotage(), date.formatterMysqlShort));
...
*/
   ...
   public String getModelDataFile() {
    ...
    public String getError(String intOval, GridLigneMaritimesVOM2 vo) {
        new logger().oCategory.info("intOval : " + intOval);
        int Oval = new Integer(intOval);
        
        if (Oval == (vo.KEY_date_empotage)) {
            return "Date de Pese";
        }
