 ...
 * @author Admin
 */
public class ZipFiles extends files {
    ...
    public void InitFiles() {
        this.setExtention(enumExtentionFiles.ZIP);
    }
    ...
    public static void main(String[] args)
            throws IOException {
        ZipFiles.compress("D:\\test\\", "C:\\EXTSMA\\EXTS\\ZIP\\", Deflater.BEST_SPEED);
        //ZipFiles.decompress("C:\\EXTSMA\\EXTS\\ZIP\\test.zip", "C:\\EXTSMA\\EXTS\\UNZIP\\"+new date().getDate(), false);
    }
